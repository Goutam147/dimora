/*! @version pwa-studio: 0.0.1, @magento/venia-ui: ~10.3.0, @magento/venia-product-recommendations: ^1.0.1, @magento/upward-security-headers: ~1.0.14, @magento/pwa-theme-venia: ~1.4.0, @magento/pwa-buildpack: ~11.4.3, @magento/peregrine: ~13.2.1, @magento/pagebuilder: ~8.2.1, @magento/eslint-config: ~1.5.0, @magento/babel-preset-peregrine: ~1.2.3, @apollo/client: ~3.5.0 */
...
var F=Object(n.useRef)(),T=Object(n.useRef)(s),R=Object(n.useRef)(),I=Object(n.useRef)(!1),L=c(function(){return R.current&&s===T.current?R.current:w(m.getState(),s)},[m,C,s])
useIsomorphicLayoutEffectWithArgs(captureWrapperProps,[T,F,I,s,L,R,S]),useIsomorphicLayoutEffectWithArgs(subscribeUpdates,[O,m,k,w,T,F,I,R,S,_],[m,k,w])
var M=Object(n.useMemo)(function(){return o.a.createElement(t,_extends({},L,{ref:l}))},[l,t,L])
return Object(n.useMemo)(function(){return O?o.a.createElement(f.Provider,{value:x},M):M},[f,M,x])}var h=l?o.a.memo(ConnectFunction):ConnectFunction
...
return t.filter(function(e){return e}).join(" ")}(d,l):d,F=P?_extends({},w,f):w,T=_extends({"aria-current":P&&o||null,className:_,style:F,to:a},S)
return y!==v?T.ref=t||k:T.innerRef=k,i.a.createElement(h,T)})})},"56Qq":function(e,t,r){"use strict"
...
"required"===o&&(a="".concat(a,".").concat(i.missingProperty)),a=a.replace(".",""),y.set(r,a,t)}),r},T=function uuidv4(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){var t=16*Math.random()|0
return("x"==e?t:3&t|8).toString(16)})},R=function computeFieldFromProperty(e,t,r){var n=t["ui:control"],o=t["informed:props"],i=t["input:props"],a=t["ui:before"],u=t["ui:after"],l=t.oneOf,s=t.items,c=t.enum,f=t.title,d=t.minimum,p=t.maximum,h=t.minLength,y=t.maxLength,v=t.pattern,g=t.type,b=t.properties,m=T()
i&&i.id&&(m=i.id)
...
return _objectSpread2({value:e.const,label:e.title},r)})
O.props.options=k}return O},I=function computeFieldsFromSchema(e,t,r){if(!e||t)return[]
...
0!=p()&&i?r.current.setSelectionRange(e+1,e+1):i&&r.current.setSelectionRange(e,e)}},[t]),{setCursorOffset:d,setCursor:l,cursor:u,getCursor:s,cursorOffset:f}},z=a("informed:useField\t"),N=function initializeValue(e,t,r,n,o){if(null!=e)return o?o(e):t?t(e):r&&!n?L(e,r).value:e},D=function initializeMask(e,t,r,n){return t&&r?t(e):n?L(e,n).value:e},W=function generateValidationFunction(e,t,r){var n=r.required
...
var Fe=Object(n.useRef)(null),Te=o.a.useMemo(function(){return t||Fe},[]),Re=A({value:pe,inputRef:Te,maintainCursor:!!C}),Ie=Re.getCursor,Le=Re.setCursor,Me=Re.setCursorOffset,Ae=function relevantFunc(){return!0},ze=function relevant(e){var t=$||Ae,r=ne.getFullField(Pe.current)||Pe.current,n={path:r,parentPath:r.replace(/(.*)[.[].*/,"$1"),get:function get(e,t){return y.get(e,t)}}
...
if(""!==i||j||o.allowEmptyString||a.allowEmptyStrings||(i=void 0),"number"!==e.type&&"number"!==R||void 0===i||(i=+i),n&&n.target&&n.target.selectionStart&&Le(n.target.selectionStart),l&&!w&&(u=l(i,Ie()),i=l(i,Ie())),s&&!w){var h=s(i,Ie())
u=h.value,i=h.value,Me(h.offset)}if(c&&f&&(i=f(i),u=c(i)),d){var y=L(i,d)
Me(y.offset),i=u=y.value}p&&(i=null!=i?p(i):i),se&&g&&!o.initial&&(z("Validating after change ".concat(r," ").concat(i)),Qe(se(i,ne.getValues()))),he(i),Ee(u),k&&k(i),ee.setValue(Z,i,!o.preventUpdate)},Ue=function setTouched(e,t){var n=(arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}).preventUpdate
...
Me(i.offset),he(i.value),Ee(i.value),k&&k(i.value),ee.setValue(Z,i.value,!n)}je(e),ee.setTouched(Z,e,!n)},He={setValue:Be,setTouched:Ue,setError:Qe,reset:function reset(){var e=(arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}).preventUpdate,t=N(Ce.current||ee.getInitialValue(Pe.current),l,d,p,J)
...
_&&(Ge={error:ge,touched:we}),z("Render",ne.getFullField(r),Ge),M(function(){var e=ne.getFullField(Pe.current)
...
return ie.current?ie.current=!1:(z("Update",r,re),ae.current.field=e,ee.update(Z,ae.current,_e.current)),function(){_e.current=e}},[r]),M(function(){P&&Te&&(Te.current.style.border="5px solid orange",setTimeout(function(){Te.current.style.borderWidth="2px",Te.current.style.borderStyle="inset",Te.current.style.borderColor="initial",Te.current.style.borderImage="initial"},500))})
var $e=[].concat(_toConsumableArray(Object.values(Ge)),_toConsumableArray(Object.values(e)),_toConsumableArray(Object.values(X))),Ke=r,Ye=V({fieldType:R,setValue:Be,onChange:U,multiple:I,ref:Te}),Je=q({setTouched:Ue,onBlur:H}),Xe=Q({fieldType:R,maskedValue:xe,multiple:I,value:pe}),Ze=B(R)
return{fieldState:Ge,fieldApi:He,render:function render(e){return Object(n.useMemo)(function(){return De?e:null},_toConsumableArray($e))},ref:Te,userProps:_objectSpread2(_objectSpread2({},X),{},{multiple:I,onChange:U,onBlur:H,id:X.id||Z}),informed:_objectSpread2({name:Ke,multiple:I,onChange:Ye,onBlur:Je,value:Xe,ref:Te,type:Ze,id:X.id||Z},X)}}var H=function asField(e){var t=o.a.forwardRef(function(t,r){var n=useField(t,r),i=n.fieldState,a=n.fieldApi,u=n.render,l=n.ref,s=n.userProps
...
return o.a.createElement("input",_extends({},y,{name:p,ref:h,value:c,checked:i===c,onChange:function onChange(e){e.target.checked&&(a(c),f&&f(e),l&&l(e))},onBlur:function onBlur(e){u(!0),d&&d(e),s&&s(e)},type:"radio"}))}),ee=function(e){_inherits(RadioGroup,n["Component"])
...
var re=a("informed:useArrayField\t"),ne=function useArrayField(e){var t=e.field,r=e.initialValue,i=e.validate,a=e.arrayFieldApiRef,u=_objectWithoutProperties(e,["field","initialValue","validate","arrayFieldApiRef"]),l=useFormApi(),s=_slicedToArray(Object(n.useState)(new Map),1)[0],c=Object(n.useContext)(v),f=l.getFullField(t),d=c.getInitialValue(t)||r||[],p=_slicedToArray(useStateWithGetter(l.getSavedValue(f)&&l.getSavedValue(f).value||d),3),h=p[0],g=p[1],b=p[2],m=_slicedToArray(useStateWithGetter(h?h.map(function(){return T()}):[]),3),j=m[0],k=m[1],S=m[2],x=Object(n.useMemo)(function(){return function(e,t){var r=null==S()?0:S().length
return i?i(e,r,t):void 0}}),E=useField(_objectSpread2({field:t,validate:i?x:void 0,shadow:!0},u)).fieldApi
M(function(){var e=function onChangeHandler(e){e!==f&&(re("".concat(f," changed")),RegExp("".concat(f,"\\[[0-9]+\\]")).test(e)&&E.validate())}
...
j[e]&&j[r]&&(n[e]=j[r],n[r]=j[e]),k(n)},P=function add(){j.push(T()),k(_toConsumableArray(j))},_=function addWithInitialValue(e){j.push(T()),k(_toConsumableArray(j))
...
k(n)}}
a&&(a.current=R)
var I={fields:F,field:t},L=_objectSpread2(_objectSpread2({},c),{},{register:function register(e,t){s.set(e,t)
...
return o.a.createElement(i,{key:"ui-comp-".concat(t)})}):null},ce=a("informed:FormFields\t"),fe=function FormFields(e){var t=e.schema,r=e.prefix,i=e.onlyValidateSchema,a=Object(n.useContext)(v).fieldMap
return Object(n.useMemo)(function(){return I(t,i,r).map(function(e,t){var r=e.field,n=e.props,i=e.type,u=e.properties,l=e.items,s=e.componentType,c=e.uiBefore,f=e.uiAfter,d=e.allOf,p=a[s]
...
me("Render useForm")
var j=Object(n.useMemo)(function(){return{dontPreventDefault:t,initialValues:r,validate:i,validateFields:a,allowEmptyStrings:u,preventEnter:l,validationSchema:v,schema:g,ajv:b,fieldMap:m}},[t,r,i,a,u,l,v,g,b,m]),k=_slicedToArray(Object(n.useState)(function(){return new ve(j)}),1)[0]
...
M(function(){var e=function onChangeHandler(){return f&&f(k.getFormState())},t=function onResetHandler(){return d&&d()},r=function onSubmitHandler(){return p&&p(k.getFormState().values)},n=function onValueHandler(){return h&&h(k.getFormState().values)},o=function onFailureHandler(){return y&&y(k.getFormState().errors)}
return k.on("change",e),k.on("reset",t),k.on("submit",r),k.on("value",n),k.on("failure",o),function(){k.removeListener("change",e),k.removeListener("reset",t),k.removeListener("submit",r),k.removeListener("value",n),k.removeListener("failure",o)}},[f,d,p,h,y]),Object(n.useState)(function(){k.on("change",function onChangeHandlerRerender(){me("Setting form state"),E(k.getFormState())}),s&&s(k.getFormApi()),c&&(c.current=k.getFormApi())})
...
default:return t}}case o:return t}}}var j=l,k=n,S=c,x=i,E=h,C=p,P=o,_=u,F=a,T=f
...
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="ArrowUpCircle",t.a=u},EAKA:function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("TzuY"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="ArrowLeft",t.a=u},HWP6:function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("TzuY"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(e)
for(n=0;n<i.length;n++)r=i[n],t.indexOf(r)>=0||Object.prototype.propertyIsEnumerable.call(e,r)&&(o[r]=e[r])}return o}var u=Object(n.forwardRef)(function(e,t){var r=e.color,n=void 0===r?"currentColor":r,i=e.size,a=void 0===i?24:i,u=_objectWithoutProperties(e,["color","size"])
return o.a.createElement("svg",_extends({ref:t,xmlns:"http://www.w3.org/2000/svg",width:a,height:a,viewBox:"0 0 24 24",fill:"none",stroke:n,strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"},u),o.a.createElement("path",{d:"M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"}))})
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="Shield",t.a=u},HuS5:function(e,t,r){"use strict"
...
var F=r("L2ys"),T=r("mph4"),R=r("CuOm"),I=r("uiNf"),L=function(){function LocalState(e){var t=e.cache,r=e.client,n=e.resolvers,o=e.fragmentMatcher
...
void 0!==t&&l.push(((r={})[Object(b.i)(e)]=t,r))})]:(Object(b.f)(e)?s=e:(s=i[e.name.value],Object(o.b)(s,"No fragment named ".concat(e.name.value))),s&&s.typeCondition&&(c=s.typeCondition.name.value,r.fragmentMatcher(t,c,a))?[2,this.resolveSelectionSet(s.selectionSet,t,r).then(function(e){l.push(e)})]:[2]):[2]})})},[2,Promise.all(e.selections.map(s)).then(function(){return Object(T.c)(l)})]})})},LocalState.prototype.resolveField=function(e,t,r){return Object(n.b)(this,void 0,void 0,function(){var o,i,a,u,l,s,c,f,d,p=this
...
M.has(r)||(M.set(r,0),wrapDestructiveCacheMethod(r,"evict"),wrapDestructiveCacheMethod(r,"modify"),wrapDestructiveCacheMethod(r,"reset"))}return QueryInfo.prototype.init=function(e){var t=e.networkStatus||S.a.loading
...
void 0===h&&(h=p)
var y=h(function(e,t){var r=e.innerRef,n=e.navigate,i=e.onClick,a=_objectWithoutPropertiesLoose(e,["innerRef","navigate","onClick"]),u=a.target,l=_extends({},a,{onClick:function onClick(e){try{i&&i(e)}catch(t){throw e.preventDefault(),t}e.defaultPrevented||0!==e.button||u&&"_self"!==u||function isModifiedEvent(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}(e)||(e.preventDefault(),n())}})
return l.ref=p!==h&&t||r,o.createElement("a",l)})
y.displayName="LinkAnchor"
var v=h(function(e,t){var r=e.component,a=void 0===r?y:r,u=e.replace,s=e.to,c=e.innerRef,v=_objectWithoutPropertiesLoose(e,["component","replace","to","innerRef"])
return o.createElement(n.__RouterContext.Consumer,null,function(e){e||l(!1,"You should not use <Link> outside a <Router>")
var r=e.history,n=d(f(s,e.location),e.location),y=n?r.createHref(n):"",g=_extends({},v,{href:y,navigate:function navigate(){var t=f(s,e.location),n=i.createPath(e.location)===i.createPath(d(t));(u||n?r.replace:r.push)(t)}})
...
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="Grid",t.a=u},TzuY:function(e,t,r){e.exports=r("6NzY")()},Ud0y:function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("TzuY"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="Printer",t.a=u},Ytkj:function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("TzuY"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="Users",t.a=u},Z9pI:function(e,t,r){"use strict"
...
return t})}catch(e){return e}}var T=r("Z9pI"),R=r("gclO"),I=r("6l/j")
var L=r("uiNf"),M=Object.create(null)
...
return u[0]=a,extractKeyPath(o,u)}}else if(n&&Object(R.a)(n.directives)){var l=r.slice(1),s=n.directives.find(function(e){return e.name.value===l}),f=s&&Object(c.a)(s,o)
...
return L.a.withValue(this.cache,l,[a,s])}return a}},Policies.prototype.getReadFunction=function(e,t){var r=this.getFieldPolicy(e,t,!1)
...
return"string"==typeof a?i={fieldName:a,from:l>1?u:t}:(i=Object(n.a)({},a),w.e.call(i,"from")||(i.from=t)),void 0===i.from&&o.b.warn("Undefined 'from' passed to readField with arguments ".concat(function stringifyForDisplay(e){var t=Object(I.a)("stringifyForDisplay")
...
return maybeRecycleChildMergeTree(n,i),a}):this.processSelectionSet({result:e,selectionSet:t.selectionSet,context:r,mergeTree:n}):Object(T.a)(e)},StoreWriter.prototype.flattenFields=function(e,t,r,n){void 0===n&&(n=Object(c.c)(t,e,r.fragmentMap))
...
if(a&&s||!Object(R.a)(e.directives)||e.directives.forEach(function(e){var t=e.name.value
...
return r.watches=new Set,r.typenameDocumentCache=new Map,r.makeVar=L.c,r.txCount=0,r.config=Object(w.h)(t),r.addTypename=!!r.config.addTypename,r.policies=new W({cache:r,dataIdFromObject:r.config.dataIdFromObject,possibleTypes:r.config.possibleTypes,typePolicies:r.config.typePolicies}),r.init(),r}return Object(n.c)(InMemoryCache,e),InMemoryCache.prototype.init=function(){var e=this.data=new x.Root({policies:this.policies,resultCaching:this.config.resultCaching})
...
return this.watches.size||Object(L.d)(this),this.watches.add(e),e.immediate&&this.maybeBroadcastWatch(e),function(){t.watches.delete(e)&&!t.watches.size&&Object(L.b)(t),t.maybeBroadcastWatch.forget(e)}},InMemoryCache.prototype.gc=function(e){_.b.reset()
...
return this.init(),_.b.reset(),e&&e.discardWatches?(this.watches.forEach(function(e){return t.maybeBroadcastWatch.forget(e)}),this.watches.clear(),Object(L.b)(this)):this.broadcastWatches(),Promise.resolve()},InMemoryCache.prototype.removeOptimistic=function(e){var t=this.optimisticData.removeLayer(e)
...
t&&(e.optimistic&&"string"==typeof t.optimistic&&(n.fromOptimisticTransaction=!0),t.onWatchUpdated&&!1===t.onWatchUpdated.call(this,e,n,r))||r&&Object(a.a)(r.result,n.result)||e.callback(e.lastDiff=n,r)},InMemoryCache}(l)},mGc7:function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("TzuY"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="ArrowRightCircle",t.a=u},"mV+O":function(e,t,r){"use strict"
var n=r("q1tI"),o=r.n(n),i=r("TzuY"),a=r.n(i)
function _extends(){return(_extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var r=arguments[t]
for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(e[n]=r[n])}return e}).apply(this,arguments)}function _objectWithoutProperties(e,t){if(null==e)return{}
var r,n,o=function _objectWithoutPropertiesLoose(e,t){if(null==e)return{}
...
u.propTypes={color:a.a.string,size:a.a.oneOfType([a.a.string,a.a.number])},u.displayName="Camera",t.a=u},mph4:function(e,t,r){"use strict"
...
return{controller:e,signal:e.signal}}(),F=_.controller,T=_.signal;(w=F)&&(E.signal=T)}if(b&&!e.query.definitions.some(function(e){return"OperationDefinition"===e.kind&&"mutation"===e.operation})&&(E.method="GET"),"GET"===E.method){var R=function rewriteURIForGET(e,t){var r=[],n=function(e,t){r.push("".concat(e,"=").concat(encodeURIComponent(t)))}
...
return t.filter(function(e){return e}).join(" ")}(d,l):d,F=P?_extends({},w,s):w,T=_extends({"aria-current":P&&n||null,className:_,style:F,to:a},S)
return v!==g?T.ref=t||k:T.innerRef=k,i.createElement(y,T)})})
...
if(xe=Se=null,Bb(e),t)for(e=0;e<t.length;e++)Bb(t[e])}}function Gb(e,t){return e(t)}function Hb(e,t,r,n,o){return e(t,r,n,o)}function Ib(){}var Pe=Gb,_e=!1,Te=!1
...
return r}var Re=!1
if(m)try{var Ie={}
Object.defineProperty(Ie,"passive",{get:function(){Re=!0}}),window.addEventListener("test",Ie,Ie),window.removeEventListener("test",Ie,Ie)}catch(fe){Re=!1}var Me=!1,ze=null,We=!1,Ve=null,qe={onError:function(e){Me=!0,ze=e}}
...
e&&(e.stopPropagation?e.stopPropagation():"unknown"!=typeof e.cancelBubble&&(e.cancelBubble=!0),this.isPropagationStopped=pd)},persist:function(){},isPersistent:pd}),b}var _t,Ft,Tt,Rt={eventPhase:0,bubbles:0,cancelable:0,timeStamp:function(e){return e.timeStamp||Date.now()},defaultPrevented:0,isTrusted:0},It=rd(Rt),Lt=a({},Rt,{view:0,detail:0}),Mt=rd(Lt),At=a({},Lt,{screenX:0,screenY:0,clientX:0,clientY:0,pageX:0,pageY:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,getModifierState:zd,button:0,buttons:0,relatedTarget:function(e){return void 0===e.relatedTarget?e.fromElement===e.srcElement?e.toElement:e.fromElement:e.relatedTarget},movementX:function(e){return"movementX"in e?e.movementX:(e!==Tt&&(Tt&&"mousemove"===e.type?(_t=e.screenX-Tt.screenX,Ft=e.screenY-Tt.screenY):Ft=_t=0,Tt=e),_t)},movementY:function(e){return"movementY"in e?e.movementY:Ft}}),zt=rd(At),Nt=rd(a({},At,{dataTransfer:0})),Dt=rd(a({},Lt,{relatedTarget:0})),Wt=rd(a({},Rt,{animationName:0,elapsedTime:0,pseudoElement:0})),Vt=rd(a({},Rt,{clipboardData:function(e){return"clipboardData"in e?e.clipboardData:window.clipboardData}})),qt=rd(a({},Rt,{data:0})),Qt={Esc:"Escape",Spacebar:" ",Left:"ArrowLeft",Up:"ArrowUp",Right:"ArrowRight",Down:"ArrowDown",Del:"Delete",Win:"OS",Menu:"ContextMenu",Apps:"ContextMenu",Scroll:"ScrollLock",MozPrintableKey:"Unidentified"},Bt={8:"Backspace",9:"Tab",12:"Clear",13:"Enter",16:"Shift",17:"Control",18:"Alt",19:"Pause",20:"CapsLock",27:"Escape",32:" ",33:"PageUp",34:"PageDown",35:"End",36:"Home",37:"ArrowLeft",38:"ArrowUp",39:"ArrowRight",40:"ArrowDown",45:"Insert",46:"Delete",112:"F1",113:"F2",114:"F3",115:"F4",116:"F5",117:"F6",118:"F7",119:"F8",120:"F9",121:"F10",122:"F11",123:"F12",144:"NumLock",145:"ScrollLock",224:"Meta"},Ut={Alt:"altKey",Control:"ctrlKey",Meta:"metaKey",Shift:"shiftKey"}
...
if("Unidentified"!==t)return t}return"keypress"===e.type?13===(e=od(e))?"Enter":String.fromCharCode(e):"keydown"===e.type||"keyup"===e.type?Bt[e.keyCode]||"Unidentified":""},code:0,location:0,ctrlKey:0,shiftKey:0,altKey:0,metaKey:0,repeat:0,locale:0,getModifierState:zd,charCode:function(e){return"keypress"===e.type?od(e):0},keyCode:function(e){return"keydown"===e.type||"keyup"===e.type?e.keyCode:0},which:function(e){return"keypress"===e.type?od(e):"keydown"===e.type||"keyup"===e.type?e.keyCode:0}})),Gt=rd(a({},At,{pointerId:0,width:0,height:0,pressure:0,tangentialPressure:0,tiltX:0,tiltY:0,twist:0,pointerType:0,isPrimary:0})),$t=rd(a({},Lt,{touches:0,targetTouches:0,changedTouches:0,altKey:0,metaKey:0,ctrlKey:0,shiftKey:0,getModifierState:zd})),Kt=rd(a({},Rt,{propertyName:0,elapsedTime:0,pseudoElement:0})),Yt=rd(a({},At,{deltaX:function(e){return"deltaX"in e?e.deltaX:"wheelDeltaX"in e?-e.wheelDeltaX:0},deltaY:function(e){return"deltaY"in e?e.deltaY:"wheelDeltaY"in e?-e.wheelDeltaY:"wheelDelta"in e?-e.wheelDelta:0},deltaZ:0,deltaMode:0})),Jt=[9,13,27,32],Xt=m&&"CompositionEvent"in window,Zt=null
...
Te=!0
try{return Pe(e,t,r)}finally{Te=!1,Mb()}}(function(){var n=i,o=xb(r),a=[]
e:{var u=vt.get(e)
...
var _r=Math.random().toString(36).slice(2),Fr="__reactFiber$"+_r,Tr="__reactProps$"+_r,Rr="__reactContainer$"+_r,Ir="__reactEvents$"+_r
...
throw Error(y(33))}function Db(e){return e[Tr]||null}function $e(e){var t=e[Ir]
return void 0===t&&(t=e[Ir]=new Set),t}var Lr=[],Mr=-1
function Bf(e){return{current:e}}function H(e){0>Mr||(e.current=Lr[Mr],Lr[Mr]=null,Mr--)}function I(e,t){Lr[++Mr]=e.current,e.current=t}var Ar={},zr=Bf(Ar),Nr=Bf(!1),Dr=Ar
...
if("object"==typeof r&&null!==r){switch(r.$$typeof){case T:return r.key===i?r.type===L?n(e,t,r.props.children,o,i):k(e,t,r,o):null
...
if("object"==typeof o&&null!==o){switch(o.$$typeof){case T:return e=e.get(null===o.key?r:o.key)||null,o.type===L?n(t,e,o.props.children,i,o.key):k(t,e,o,i)
...
if(a)switch(n.$$typeof){case T:e:{for(a=n.key,i=r;null!==i;){if(i.key===a){switch(i.tag){case 7:if(n.type===L){c(t,i.sibling),(r=e(i,n.props.children)).return=t,t=r
break e}break
...
Cn.length=0}var Pn=F.ReactCurrentDispatcher,_n=F.ReactCurrentBatchConfig,Fn=0,Tn=null,Rn=null,In=null,Ln=!1,Mn=!1
...
return!0}function Ch(e,t,r,n,o,i){if(Fn=i,Tn=t,t.memoizedState=null,t.updateQueue=null,t.lanes=0,Pn.current=null===e||null===e.memoizedState?zn:Nn,e=r(n,o),Mn){i=0
do{if(Mn=!1,!(25>i))throw Error(y(301))
i+=1,In=Rn=null,t.updateQueue=null,Pn.current=Dn,e=r(n,o)}while(Mn)}if(Pn.current=An,t=null!==Rn&&null!==Rn.next,Fn=0,In=Rn=Tn=null,Ln=!1,t)throw Error(y(300))
return e}function Hh(){var e={memoizedState:null,baseState:null,baseQueue:null,queue:null,next:null}
return null===In?Tn.memoizedState=In=e:In=In.next=e,In}function Ih(){if(null===Rn){var e=Tn.alternate
e=null!==e?e.memoizedState:null}else e=Rn.next
var t=null===In?Tn.memoizedState:In.next
if(null!==t)In=t,Rn=e
else{if(null===e)throw Error(y(310))
e={memoizedState:(Rn=e).memoizedState,baseState:Rn.baseState,baseQueue:Rn.baseQueue,queue:Rn.queue,next:null},null===In?Tn.memoizedState=In=e:In=In.next=e}return In}function Jh(e,t){return"function"==typeof t?t(e):t}function Kh(e){var t=Ih(),r=t.queue
...
null===u?(a=u=c,i=n):u=u.next=c,Tn.lanes|=s,uo|=s}l=l.next}while(null!==l&&l!==o)
...
try{r(e(t._source))
var n=Ig(v)
o.mutableReadLanes|=n&o.pendingLanes}catch(e){r(function(){throw e})}})},[t,n]),dr(p,r)&&dr(h,t)&&dr(f,n)||((e={pending:null,dispatch:null,lastRenderedReducer:Jh,lastRenderedState:c}).dispatch=s=Oh.bind(null,Tn,e),l.queue=e,l.baseQueue=null,c=Mh(o,t,r),l.memoizedState=l.baseState=c),c}function Ph(e,t,r){return Nh(Ih(),e,t,r)}function Qh(e){var t=Hh()
return"function"==typeof e&&(e=e()),t.memoizedState=t.baseState=e,e=(e=t.queue={pending:null,dispatch:null,lastRenderedReducer:Jh,lastRenderedState:e}).dispatch=Oh.bind(null,Tn,e),[t.memoizedState,e]}function Rh(e,t,r,n){return e={tag:e,create:t,destroy:r,deps:n,next:null},null===(t=Tn.updateQueue)?(t={lastEffect:null},Tn.updateQueue=t,t.lastEffect=e.next=e):null===(r=t.lastEffect)?t.lastEffect=e.next=e:(n=r.next,r.next=e,e.next=n,t.lastEffect=e),e}function Sh(e){return e={current:e},Hh().memoizedState=e}function Th(){return Ih().memoizedState}function Uh(e,t,r,n){var o=Hh()
Tn.flags|=e,o.memoizedState=Rh(1|t,r,void 0,void 0===n?null:n)}function Vh(e,t,r,n){var o=Ih()
n=void 0===n?null:n
var i=void 0
if(null!==Rn){var a=Rn.memoizedState
if(i=a.destroy,null!==n&&Bh(n,a.deps))return void Rh(t,r,i,n)}Tn.flags|=e,o.memoizedState=Rh(1|t,r,i,n)}function Wh(e,t){return Uh(516,4,e,t)}function Xh(e,t){return Vh(516,4,e,t)}function Yh(e,t){return Vh(4,2,e,t)}function Zh(e,t){return"function"==typeof t?(e=e(),t(e),function(){t(null)}):null!=t?(e=e(),t.current=e,function(){t.current=null}):void 0}function $h(e,t,r){return r=null!=r?r.concat([e]):null,Vh(4,2,Zh.bind(null,t,e),r)}function ai(){}function bi(e,t){var r=Ih()
t=void 0===t?null:t
...
if(null===a?i.next=i:(i.next=a.next,a.next=i),t.pending=i,a=e.alternate,e===Tn||null!==a&&a===Tn)Mn=Ln=!0
...
return t=void 0!==r?r(t):t,n.memoizedState=n.baseState=t,e=(e=n.queue={pending:null,dispatch:null,lastRenderedReducer:e,lastRenderedState:t}).dispatch=Oh.bind(null,Tn,e),[n.memoizedState,e]},useRef:Sh,useState:Qh,useDebugValue:ai,useDeferredValue:function(e){var t=Qh(e),r=t[0],n=t[1]
...
return 0==(2&Tn.mode)&&(Tn.flags|=516,Rh(5,function(){r("r:"+(Pr++).toString(36))},void 0,null)),t}return Qh(t="r:"+(Pr++).toString(36)),t},unstable_isNewReconciler:!1},Nn={readContext:vg,useCallback:bi,useContext:vg,useEffect:Xh,useImperativeHandle:$h,useLayoutEffect:Yh,useMemo:ci,useReducer:Kh,useRef:Th,useState:function(){return Kh(Jh)},useDebugValue:ai,useDeferredValue:function(e){var t=Kh(Jh),r=t[0],n=t[1]
...
switch(n[Fr]=t,n[Tr]=i,r){case"dialog":G("cancel",n),G("close",n)
break
...
e=t.type
var i=t.updateQueue
if(t.updateQueue=null,null!==i){for(r[Tr]=n,"input"===e&&"radio"===n.type&&null!=n.name&&$a(r,n),wb(e,o),t=wb(e,n),o=0;o<i.length;o+=2){var a=i[o],u=i[o+1]
...
function wj(){po=un()+500}var ho,yo=null,vo=!1,go=null,bo=null,mo=!1,Oo=null,wo=90,jo=[],ko=[],So=null,xo=0,Eo=null,Co=-1,Po=0,_o=0,Fo=null,To=!1
...
try{if(qg(),Pn.current=An,Ln){for(var n=Tn.memoizedState;null!==n;){var o=n.queue
null!==o&&(o.pending=null),n=n.next}Ln=!1}if(Fn=0,In=Rn=Tn=null,Mn=!1,Jn.current=null,null===r||null===r.return){oo=1,io=t,eo=null
...
xr={focusedElem:a,selectionRange:u},xt=!1,Fo=null,To=!1,yo=n
...
To||null===Fo||(0!=(8&yo.flags)?dc(yo,Fo)&&(To=!0):13===yo.tag&&mj(e,yo)&&dc(yo,Fo)&&(To=!0))
var t=yo.flags
