  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#FAF3EB] border-t border-[#F0DEC9] py-2.5 px-4 md:hidden shadow-lg">
      <div className="grid grid-cols-4 items-center justify-items-center text-center">
        {/* Account */}
        <a href="#account" className="flex flex-col items-center text-[#B30018] group">
        ...
        {/* Categories */}
        <a href="#categories" className="flex flex-col items-center text-[#444444] hover:text-[#B30018] transition-colors group">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
        ...
        {/* Gold Scheme */}
        <a href="#scheme" className="flex flex-col items-center text-[#444444] hover:text-[#B30018] transition-colors group">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
        ...
        {/* Help */}
        <a href="#help" className="flex flex-col items-center text-[#444444] hover:text-[#B30018] transition-colors group">
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
