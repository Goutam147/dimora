      ...
      <div className="max-w-[1340px] mx-auto px-5">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 max-w-[1240px] mx-auto pt-4">
          ...
          <div className="relative w-full max-w-[340px] sm:max-w-[540px] h-[300px] sm:h-[370px] flex items-center justify-start mx-auto sm:mx-0">
            ...
            <div className="absolute left-[120px] sm:left-[245px] top-[20px] sm:top-[30px] w-[180px] sm:w-[250px] h-[230px] sm:h-[300px] rounded-2xl overflow-hidden shadow-2xl border-2 sm:border-4 border-white bg-[#4A121A] z-10 transition-transform duration-300 hover:scale-[1.02]">
              <img
                src="/images/necklace_hero.jpg"
          ...
          <div className="w-full lg:w-[580px] flex flex-col items-center sm:items-start text-center sm:text-left">
            <h3 className="font-serif text-2xl sm:text-[1.85rem] font-semibold text-[#111111] leading-tight mb-3">
              Need help in choosing the best Jewellery?
            </h3>
            <p className="font-sans text-xs sm:text-[0.95rem] text-[#444444] leading-relaxed mb-6 max-w-[540px]">
