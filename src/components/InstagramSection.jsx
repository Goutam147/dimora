    ...
    <section className="py-4 md:py-14 bg-white overflow-hidden" id="instagram">
      <div className="max-w-[1340px] mx-auto px-3 sm:px-5">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 md:gap-12 max-w-[1240px] mx-auto pt-4">
          {/* Left: 2 Overlapping Image Cards (1:1 Proportions) */}
          <div className="relative w-full max-w-[300px] sm:max-w-[420px] h-[215px] sm:h-[290px] flex items-center justify-start mx-auto lg:mx-0">
            {/* Base Card 1 (Model Image) */}
            <div className="w-[160px] sm:w-[220px] h-[190px] sm:h-[250px] rounded-2xl overflow-hidden shadow-md border border-black/5 bg-[#F5EFE6] relative z-0">
              <img
            ...
            <div className="absolute left-[110px] sm:left-[170px] top-[15px] sm:top-[25px] w-[160px] sm:w-[220px] h-[190px] sm:h-[250px] rounded-2xl overflow-hidden shadow-xl border-2 sm:border-4 border-white bg-[#4A121A] z-10 transition-transform duration-300 hover:scale-[1.02]">
              <img
                src="/images/necklace_hero.jpg"
