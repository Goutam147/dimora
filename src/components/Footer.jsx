        ...
        <div className="max-w-[1340px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <form onSubmit={handleSubscribe} className="flex items-center w-full max-w-[400px]">
            <div className="relative w-full flex items-center border border-[#D9BCA6] bg-white rounded overflow-hidden shadow-none">
              ...
              <button
                type="submit"
                className="px-4 py-2.5 text-[#E8A824] hover:bg-[#E8A824] hover:text-white transition-colors text-base"
          ...
          {/* Right Contact Pills (Responsive 1:1 Formatting) */}
          <div className="flex flex-wrap sm:flex-nowrap items-center justify-center sm:justify-start gap-4 sm:gap-8 w-full sm:w-auto">
            {/* Call Us */}
            <div className="flex items-center gap-2.5 shrink-0">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#FAF0E6] flex items-center justify-center text-[#E8A824] shrink-0 border border-[#F2E6D8]">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#E8A824" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                </svg>
              </div>
              <div>
                <span className="font-sans text-[0.68rem] text-[#666666] block leading-none mb-1">Call Us</span>
                <span className="font-sans text-xs sm:text-sm font-semibold text-[#111111] whitespace-nowrap">+91 9888888887</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              ...
              <div>
                <span className="font-sans text-[0.68rem] text-[#666666] block leading-none mb-1">Email Us</span>
                <span className="font-sans text-xs sm:text-sm font-semibold text-[#111111] whitespace-nowrap">contact@diamora.in</span>
              </div>
            </div>
          </div>
        </div>
