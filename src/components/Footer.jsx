...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#FAF3EB] border-t border-[#EFE2D5] text-[#333333] font-sans">
      {/* 1. TOP NEWSLETTER & QUICK CONTACT BAR */}
      <div className="border-b border-[#EFE2D5] py-7 px-5">
        <div className="max-w-[1340px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-6">
          {/* Left Text */}
          <div className="text-center lg:text-left">
            <h3 className="font-serif text-2xl font-semibold text-[#111111] leading-tight">
          ...
          <form onSubmit={handleSubscribe} className="flex items-center w-full max-w-[420px]">
            <div className="relative w-full flex items-center border border-[#C5283C] bg-white rounded overflow-hidden">
              <input
                type="email"
                value={emailInput}
                onChange={(e) => setEmailInput(e.target.value)}
                placeholder="Enter Your Email"
                className="w-full px-4 py-2.5 text-sm outline-none text-[#111111] placeholder-[#888888]"
                required
              />
              <button
                type="submit"
                className="px-4 py-2.5 text-[#C5283C] hover:bg-[#C5283C] hover:text-white transition-colors text-lg"
          ...
          <div className="flex items-center gap-7">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-sans text-[0.72rem] text-[#666666] uppercase block leading-none">Call Us</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-sans text-[0.72rem] text-[#666666] uppercase block leading-none">Email Us</span>
      ...
      <div className="py-12 px-5">
        <div className="max-w-[1340px] mx-auto grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {/* Column 1: About */}
          <div>
            <h4 className="font-serif text-lg font-bold text-[#111111] mb-4">About</h4>
          ...
          <div>
            <h4 className="font-serif text-lg font-bold text-[#111111] mb-4">Jewellery Guide</h4>
            <ul className="flex flex-col gap-2 text-xs text-[#555555]">
          ...
          {/* Column 3: Media */}
          <div>
            <h4 className="font-serif text-lg font-bold text-[#111111] mb-4">Media</h4>
            <ul className="flex flex-col gap-2 text-xs text-[#555555]">
          ...
          {/* Column 4: Policies */}
          <div>
            <h4 className="font-serif text-lg font-bold text-[#111111] mb-4">Policies</h4>
            <ul className="flex flex-col gap-2 text-xs text-[#555555]">
          ...
          <div>
            <h4 className="font-serif text-lg font-bold text-[#111111] mb-4">Quick Links</h4>
            <ul className="flex flex-col gap-2 text-xs text-[#555555]">
          ...
          {/* Column 6: Help Desk */}
          <div>
            <h4 className="font-serif text-lg font-bold text-[#111111] mb-4">Help Desk</h4>
            <div className="text-xs text-[#555555] space-y-2 mb-5">
              <p><strong className="text-[#111111]">Ph:</strong> +91 9888888887</p>
              <p className="text-[0.7rem] text-[#777777]">(Mon To Saturday 10AM-6.30PM)</p>
              <p><strong className="text-[#111111]">General:</strong> <a href="mailto:contact@dimora.in" className="text-[#C5283C] underline">contact@dimora.in</a></p>
              <p><strong className="text-[#111111]">Corporate:</strong> <a href="mailto:b2bindia@dimora.in" className="text-[#C5283C] underline">b2bindia@dimora.in</a></p>
            </div>
            ...
            <div className="flex flex-col gap-2.5 mb-6">
              <a
                href="#contact"
                className="w-full text-center border border-[#C5283C] text-[#C5283C] hover:bg-[#C5283C] hover:text-white py-2 rounded text-xs font-semibold transition-colors bg-white/50"
              >
                Contact us
              </a>
              <a
            ...
            <div className="flex items-center gap-2.5">
              <a href="#facebook" className="w-8 h-8 rounded-full bg-[#F3D7C5] hover:bg-[#C5283C] hover:text-white text-[#8F3B25] flex items-center justify-center text-xs font-bold transition-colors">f</a>
              <a href="#instagram" className="w-8 h-8 rounded-full bg-[#F3D7C5] hover:bg-[#C5283C] hover:text-white text-[#8F3B25] flex items-center justify-center text-xs font-bold transition-colors">📸</a>
              <a href="#twitter" className="w-8 h-8 rounded-full bg-[#F3D7C5] hover:bg-[#C5283C] hover:text-white text-[#8F3B25] flex items-center justify-center text-xs font-bold transition-colors">𝕏</a>
              <a href="#whatsapp" className="w-8 h-8 rounded-full bg-[#F3D7C5] hover:bg-[#C5283C] hover:text-white text-[#8F3B25] flex items-center justify-center text-xs font-bold transition-colors">💬</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-t border-b border-[#EFE2D5] py-5 px-5">
        <div className="max-w-[1340px] mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-[#666666]">
          {/* Copyright Text */}
          <p>© Dimora India Ltd. 2026. All rights reserved</p>

          {/* Mobile App Buttons */}
          <div className="flex items-center gap-3">
            <a href="#googleplay" className="bg-black text-white px-3 py-1.5 rounded flex items-center gap-2 text-xs font-semibold hover:bg-gray-800 transition-colors">
              <span>▶</span> Google Play
            </a>
            <a href="#appstore" className="bg-black text-white px-3 py-1.5 rounded flex items-center gap-2 text-xs font-semibold hover:bg-gray-800 transition-colors">
              <span>🍏</span> App Store
            </a>
          </div>
          ...
          <div className="flex items-center gap-2">
            <span className="px-2 py-0.5 bg-white border border-[#E0D5C8] rounded text-[0.65rem] font-bold text-blue-800">Maestro</span>
            <span className="px-2 py-0.5 bg-white border border-[#E0D5C8] rounded text-[0.65rem] font-bold text-red-600">MasterCard</span>
            <span className="px-2 py-0.5 bg-white border border-[#E0D5C8] rounded text-[0.65rem] font-bold text-blue-600">VISA</span>
            <span className="px-2 py-0.5 bg-white border border-[#E0D5C8] rounded text-[0.65rem] font-bold text-sky-600">AMEX</span>
            <span className="px-2 py-0.5 bg-white border border-[#E0D5C8] rounded text-[0.65rem] font-bold text-blue-900">Net Banking</span>
          </div>
        </div>
      </div>

      {/* 4. SEO TEXT CONTENT SECTION */}
      <div className="py-10 px-5 bg-[#FAF3EB]">
