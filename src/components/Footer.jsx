        ...
        <div className="max-w-[1340px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap sm:flex-nowrap items-center justify-center sm:justify-start gap-4 sm:gap-8 w-full sm:w-auto">
            ...
            <div className="flex items-center gap-2.5 shrink-0">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#FAF0E6] flex items-center justify-center text-[#B82A45] shrink-0 border border-[#F2E6D8]">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#B82A45" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
